        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!--Double Part Card Header-->
                    <div class="card-body">
                        <form action="{{route('company.store')}}" id="companyForm"  method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_short_name" class="form-control" id="company_short_name" placeholder="Company Short Name">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_district" class="form-control" id="company_district" placeholder="District">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_zip_code" class="form-control" id="company_zip_code" placeholder="Zip Code">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_registration_number" class="form-control" id="company_registration_number" placeholder="Registration Number" >
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_contact_number" class="form-control" id="company_contact_number" placeholder="Contact Number" >
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_land_line" class="form-control" id="company_land_line" placeholder="Land Line Number">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_whatsapp_number" class="form-control" id="company_whatsapp_number" placeholder="Whatsapp Number" >
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="email" name="company_email" class="form-control" id="company_email" placeholder="Email Address" >
                                                        @error('company_email')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group custom-padding">
                                                        ...
                                                        <input type="text" name="company_website" class="form-control" id="company_website" placeholder="Company Website">
