...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $branches = Branch::where('status', 1) // Ensure no assignments exist for the member
                    ->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('users.index')->with('success', ' নতুন ইউজার যোগ করা সফল হয়ছে।');
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return back()->with('danger', 'message: '. $e->getMessage());
        }
    }
