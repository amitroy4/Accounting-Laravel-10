...
class WebSettingController extends Controller
{
    ...
    public function update(Request $request, WebSetting $websetting)
    {
        ...
        $validateData = $request->validate([
            ...
            'favicon' => 'nullable',
            'system_logo' => 'nullable|image|mimes:jpeg,png,jpg',
        ...
        if ($request->hasFile('system_logo')) {
            // Ensure the file is valid
            if ($request->file('system_logo')->isValid()) {
                // Store the image in the 'uploads/companyLogo' folder under the 'public' disk
                $validateData['system_logo'] = $request->file('system_logo')->store('uploads/companyLogo', 'public');
            }
        }
